...
with contextlib.suppress(ModuleNotFoundError):
    ...
    from isaaclab.devices.openxr import ManusVive, ManusViveCfg, OpenXRDevice, OpenXRDeviceCfg, Quest3OpenXRDevice, Quest3OpenXRDeviceCfg
...
DEVICE_MAP: dict[type[DeviceCfg], type[DeviceBase]] = {
    ...
    Quest3OpenXRDeviceCfg: Quest3OpenXRDevice,
